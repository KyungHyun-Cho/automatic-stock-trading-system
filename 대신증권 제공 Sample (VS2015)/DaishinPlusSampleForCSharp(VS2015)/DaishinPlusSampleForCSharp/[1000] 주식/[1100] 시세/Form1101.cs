        ...
        private void _stockCur_Received()
        {
            if (TextBoxCode.Text.ToUpper() == _stockCur.GetHeaderValue(0).ToString())
            {
                ...
                if (market == CPE_MARKET_KIND.CPC_MARKET_KOSPI)
                    _stockTable.Rows[0][7] = Convert.ToString(Convert.ToInt32(_stockCur.GetHeaderValue(10)) * 10000);
                else if (market == CPE_MARKET_KIND.CPC_MARKET_KOSDAQ || market == CPE_MARKET_KIND.CPC_MARKET_FREEBOARD)
                    _stockTable.Rows[0][7] = Convert.ToString(Convert.ToInt32(_stockCur.GetHeaderValue(10)) * 1000);
                else
